# Review of the first N=111 zero-option batch
...
These are exploratory improvements. The same N=111 diagnostics, including held-out choices, motivated the extension; this is not independent confirmatory validation.
...
| model | variant | zero_option | mean_absolute_offer_cell_residual | n_cells |
| --- | --- | --- | --- | --- |
| H5 | base | positive_positive | 0.0599 | 9 |
| H5 | base | zero | 0.2107 | 9 |
| H5 | zero | positive_positive | 0.0711 | 9 |
| H5 | zero | zero | 0.0298 | 9 |
| H7 | base | positive_positive | 0.0820 | 9 |
| H7 | base | zero | 0.1770 | 9 |
| H7 | zero | positive_positive | 0.0703 | 9 |
| H7 | zero | zero | 0.0152 | 9 |
| H8 | base | positive_positive | 0.1451 | 9 |
| H8 | base | zero | 0.1787 | 9 |
| H8 | zero | positive_positive | 0.1236 | 9 |
| H8 | zero | zero | 0.1016 | 9 |
| HPreference | base | positive_positive | 0.0771 | 9 |
| HPreference | base | zero | 0.1730 | 9 |
