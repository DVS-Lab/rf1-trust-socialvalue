...
**Individual parameter interpretation requires caution.** M5's theta recovery has mean Pearson r=0.754, RMSE=1.457, and boundary-hit rate=41.1%. See all recovery results below; optimizer convergence does not establish identification. In the expanded 12-candidate model-recovery analysis, AICc reselects M7 for only 6.3% of M7-generated datasets. **This candidate set poorly distinguishes M7's mechanism**, even though its mean in-sample criterion is favorable.

## Dataset/version and provenance

OpenNeuro **ds005123 v1.1.3**, DOI [10.18112/openneuro.ds005123.v1.1.3](https://doi.org/10.18112/openneuro.ds005123.v1.1.3), Git commit `a3213b56b7bd27d7e3ac10577558eb26bb7c2a61`. The snapshot is pinned and checked at runtime. Only Trust CSVs, task scripts, and small BIDS metadata were retrieved. **No imaging content was retrieved or analyzed.** Dataset inputs are SHA-256 hashed in `input_manifest.json`; software, seed, source-code hashes and analysis commit are in `provenance.json`.

## Task structure discovered from actual files

The canonical sample contains 114 participants. There are 113 participants with at least one auditable Trust session, 8570 presented decision rows, 8378 valid choices, and 192 missed decisions (2.24%). Decisions are reconstructed from raw logs and cross-checked against BIDS for partner, offers, choice, RT, onset, and observed feedback. Misses are represented as `missed_trial`, with 3-second BIDS RT versus 0 in raw; zero choices have no BIDS outcome. This transformation is explicitly verified, not treated as a discrepancy.
...
| partner | measure | n | mean | ci_low | ci_high |
| --- | --- | --- | --- | --- | --- |
| computer | investment | 113 | 3.521 | 3.267 | 3.777 |
| computer | high_probability | 113 | 0.477 | 0.422 | 0.531 |
| friend | investment | 113 | 4.963 | 4.769 | 5.153 |
| friend | high_probability | 113 | 0.778 | 0.738 | 0.819 |
| stranger | investment | 113 | 3.703 | 3.455 | 3.957 |
| stranger | high_probability | 113 | 0.519 | 0.466 | 0.571 |

The trial-level benchmark is a binomial GEE with exchangeable within-participant dependence and robust covariance: `chose_high ~ partner * trial_scaled + offer_pair`. It uses N=111 participant clusters, with computer as partner reference. Trial is scaled by 83 decisions. `behavior_gee.csv` contains coefficients/odds ratios and `behavior_gee.txt` the complete summary. Offer-adjusted participant contrasts independently verify the behavioral pattern:

| contrast | n | difference | ci_low | ci_high | p | p_holm |
| --- | --- | --- | --- | --- | --- | --- |
| friend - stranger | 111 | 0.249 | 0.201 | 0.302 | 0.000 | 0.000 |
| friend - computer | 111 | 0.293 | 0.234 | 0.351 | 0.000 | 0.000 |
| stranger - computer | 111 | 0.044 | 0.007 | 0.084 | 0.076 | 0.076 |

The behavioral sample spans age 21–80 years (mean 42.57, SD 17.05). Released sex counts: {'F': 69, 'M': 40, 'O': 4}. Programmed versus experienced feedback is:

| partner | programmed | experienced | feedback_trials |
| --- | --- | --- | --- |
| computer | 0.500 | 0.495 | 2309 |
| friend | 0.500 | 0.501 | 2641 |
| stranger | 0.500 | 0.499 | 2427 |
...
| model | n | converged | median_near_best | any_boundary |
| --- | --- | --- | --- | --- |
| M0 | 111 | 111 | 1.000 | 0.000 |
| M1 | 111 | 111 | 100.000 | 0.622 |
| M2 | 111 | 111 | 100.000 | 0.649 |
| M3 | 103 | 103 | 27.000 | 0.466 |
| M4 | 103 | 103 | 96.000 | 0.515 |
| M5 | 111 | 111 | 99.000 | 0.676 |
| M6 | 111 | 111 | 97.000 | 0.649 |
| M7 | 111 | 111 | 99.000 | 0.775 |
| M8 | 111 | 111 | 81.000 | 0.640 |
...
| model | n | mean | median | mean_delta | best_share |
| --- | --- | --- | --- | --- | --- |
| M7 | 111 | 82.343 | 81.321 | 5.009 | 0.126 |
| M5 | 111 | 87.729 | 98.591 | 10.396 | 0.333 |
| M6 | 111 | 88.566 | 93.636 | 11.233 | 0.072 |
| M8 | 111 | 90.396 | 99.715 | 13.063 | 0.270 |
| M1 | 111 | 101.567 | 114.341 | 24.233 | 0.045 |
| M2 | 111 | 102.393 | 116.444 | 25.059 | 0.027 |
| M0 | 111 | 103.048 | 115.062 | 25.714 | 0.126 |

Mean-criterion minima: AIC=M7, AICc=M7, BIC=M7. M5 improves on M2 by a mean 14.663 AICc units (paired 95% bootstrap interval 11.498 to 18.052; Holm-adjusted Wilcoxon p=3.49e-15). This comparison establishes improvement over simple money-only RL; it does not discriminate all alternatives. `model_deltas.csv` retains participant heterogeneity; `model_pairwise.csv` provides paired bootstrap intervals and Holm correction separately within metric/sample families.

Secondary rating-complete AICc comparison uses the same 103 participants for every candidate:

| model | n | mean | median | best_share |
| --- | --- | --- | --- | --- |
| M4 | 103 | 78.101 | 85.526 | 0.236 |
| M3 | 103 | 78.708 | 86.556 | 0.343 |
| M7 | 103 | 83.379 | 87.391 | 0.078 |
| M5 | 103 | 89.304 | 99.541 | 0.149 |
| M6 | 103 | 89.482 | 94.378 | 0.019 |
| M8 | 103 | 91.226 | 99.741 | 0.029 |
| M1 | 103 | 103.296 | 114.733 | 0.039 |
| M2 | 103 | 104.062 | 116.444 | 0.019 |
| M0 | 103 | 104.982 | 115.062 | 0.087 |
...
| model | n | log_loss | median_log_loss | accuracy | brier |
| --- | --- | --- | --- | --- | --- |
| M0 | 111 | 0.693 | 0.693 | 0.586 | 0.250 |
| M1 | 111 | 0.669 | 0.693 | 0.414 | 0.239 |
| M2 | 111 | 0.678 | 0.693 | 0.476 | 0.242 |
| M3 | 103 | 0.741 | 0.645 | 0.691 | 0.202 |
| M4 | 103 | 0.630 | 0.625 | 0.716 | 0.183 |
| M5 | 111 | 0.682 | 0.634 | 0.596 | 0.219 |
| M6 | 111 | 0.713 | 0.668 | 0.629 | 0.221 |
| M7 | 111 | 0.912 | 0.654 | 0.654 | 0.211 |
| M8 | 111 | 0.608 | 0.652 | 0.676 | 0.208 |
...
| participant_id | model | heldout_n | heldout_log_loss | boundary_parameters |
| --- | --- | --- | --- | --- |
| sub-10806 | M7 | 41 | 18.103 | kappa;theta |
| sub-10806 | M3 | 41 | 5.043 | kappa |
| sub-10956 | M3 | 42 | 4.598 | kappa |
| sub-10718 | M4 | 42 | 3.810 | alpha;kappa;theta |
| sub-10701 | M7 | 42 | 3.757 | NA |
...
Simulation checks use 200 stochastic trajectories per participant/model at fitted parameters, on actual offers/order/outcome schedules, holding the observed missing-choice mask fixed. Simulated $0 choices conceal feedback, positive investments reveal programmed outcomes. Checks cover partner, investment, offer pairs, time, and response to most recent same-partner feedback. These are **conditional simulation checks, not Bayesian posterior checks**; their intervals omit parameter uncertainty and are not confidence intervals for a population effect.

## Parameter recovery

Each fitted non-null core model is simulated and refit 50 times per participant, with 50 starts per refit. Recovery correlations are computed across participants within each repetition, then averaged; SD describes variation across simulations. Simulations use actual latent programmed outcomes and endogenous feedback censoring, not deterministic choice thresholds.

| model | parameter | n_subjects | iterations | pearson | spearman | rmse | bias | boundary_rate |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| M5 | alpha | 111 | 50 | 0.598 | 0.543 | 0.191 | 0.022 | 0.286 |
| M5 | kappa | 111 | 50 | 0.872 | 0.860 | 1.288 | 0.250 | 0.012 |
| M5 | theta | 111 | 50 | 0.754 | 0.757 | 1.457 | -0.377 | 0.411 |
| M7 | alpha | 111 | 50 | 0.618 | 0.572 | 0.163 | 0.017 | 0.281 |
| M7 | kappa | 111 | 50 | 0.789 | 0.848 | 2.686 | 0.641 | 0.042 |
| M7 | theta | 111 | 50 | 0.770 | 0.795 | 1.412 | -0.386 | 0.341 |
| M7 | theta_stranger | 111 | 50 | 0.812 | 0.823 | 1.100 | -0.179 | 0.268 |
| M8 | alpha | 111 | 50 | 0.714 | 0.724 | 0.286 | -0.024 | 0.286 |
| M8 | alpha_negative | 111 | 50 | 0.525 | 0.596 | 0.278 | 0.014 | 0.367 |
| M8 | kappa | 111 | 50 | 0.778 | 0.786 | 0.465 | 0.164 | 0.002 |
...
| comparison | n | mean_difference | median_difference | fraction_improved |
| --- | --- | --- | --- | --- |
| M2_reset - M2 | 111 | 0.048 | 0.000 | 0.162 |
| M5_reset - M5 | 111 | -0.080 | 0.000 | 0.315 |
| M5_signed - M5 | 111 | -0.081 | 0.000 | 0.036 |
| M7_signed - M7 | 111 | -0.418 | 0.000 | 0.243 |
| M4_signed - M4 | 103 | -0.104 | 0.000 | 0.039 |
| M2_lapse - M2 | 111 | 2.048 | 2.154 | 0.027 |
| M5_lapse - M5 | 111 | 1.703 | 2.206 | 0.117 |
| M2_side - M2 | 111 | 1.113 | 1.723 | 0.198 |
| M5_side - M5 | 111 | 1.045 | 1.813 | 0.198 |
| M2_power - M2 | 111 | -8.801 | -0.757 | 0.541 |
| M5_power - M5 | 111 | -7.115 | -1.812 | 0.676 |
| M5_wide - M5 | 111 | -0.000 | 0.000 | 0.000 |
| M4_ratingcentered - M4 | 103 | 8.556 | 0.304 | 0.194 |
| preference - M2 | 111 | -21.530 | -14.540 | 0.820 |
| M5_power - M2_power | 111 | -12.977 | -5.570 | 0.676 |
| M5_side - M2_side | 111 | -14.731 | -10.748 | 0.847 |
| M5_lapse - M2_lapse | 111 | -15.008 | -11.059 | 0.829 |
| M7 - preference | 111 | 1.480 | 0.452 | 0.270 |
...
Continuous standardized age predicts M5 theta, alpha, and kappa using linear and quadratic OLS with HC3 covariance. Holm correction covers all nine reported coefficient tests. No corrected age association is supported (minimum adjusted p=1.000). This does not establish absence of lifespan differences: individual MLEs are noisy/bounded, parameters may be confounded, and age is observational. Theta is the primary descriptive age parameter, but inferential interpretation is subordinate to recovery.
